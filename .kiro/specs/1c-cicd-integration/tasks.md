...
- [ ] 2.1.1 Отладить создание проектов GitLab
  ...
  - Отладить метод `initialize_gitlab()` в init_integrations.py
...
- [ ] 2.1.2 Отладить создание проектов SonarQube
  ...
  - Отладить метод `initialize_sonarqube()` в init_integrations.py
  - Убедиться в создании проектов ut103-ci и ut103-external-files
...
- [ ] 2.2.1 Создать .gitlab-ci.yml для основного проекта (ut103-ci)
...
- [ ] 2.2.2 Создать .gitlab-ci.yml для внешних файлов (ut103-external-files)
...
- [ ] 2.3.1 Настроить Pipeline Coordinator для GitSync
...
- [ ] 2.3.2 Настроить Pipeline Coordinator для PreCommit1C
